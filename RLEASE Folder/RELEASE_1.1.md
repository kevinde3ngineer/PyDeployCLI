...
- Optimization: I managed to reduce duplicate conditional statements using a simple helper function.
- An extra quit option was added to the main menu selection.
- Bug Fix: I used `textwrap` library using `dedent ` to remove leading whitespace.
